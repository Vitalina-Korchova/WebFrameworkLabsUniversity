abstract class Car{
    ...
    protected yearReleased:number;
    protected brand:string;

    constructor (brand:string, model:string, price:number, yearReleased:number ){
        this.model = model;
        this.price = price;
    ...
    public abstract dispalyInfo():void;
}

class Ford extends Car{
    private isElectric: boolean;

    constructor (model:string, price:number, yearReleased:number,isElectric: boolean ){
...
class Toyota extends Car{
    ...
    constructor( model:string, price:number, yearReleased:number,engineType: string){
...
class BMW extends Car{
    ...
    private numberPassengers:number;

    constructor( model:string, price:number, yearReleased:number,numberPassengers:number){
